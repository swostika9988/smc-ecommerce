        ...
        <div class="flex h-fullscreen">
            <div class="w-56 bg-gradient-to-b from-gray-400 to-gray-600 text-white shadow-lg min-h-screen">
                ...
                <div class="mt-5">
                    ...
                    <a href="{{route('user.index')}}" class="block px-4 py-3 text-lg font-bold border-l-4 border-transparent transition-all duration-300 hover:border-red-600 hover:bg-gray-700">Users</a>
        
                    <a href="{{route('order.index')}}" class="block px-4 py-3 text-lg font-bold border-l-4 border-transparent transition-all duration-300 hover:border-red-600 hover:bg-gray-700">Orders</a>
